...
var author$project$ToasterTests$initToastersTest = A2(elm_explorations$test$Expect$equal, author$project$Toasters$init, author$project$Toasters$init);
...
var author$project$ToasterTests$tests = A2(
	elm_explorations$test$Test$test,
	'Init Toasters',
	elm$core$Basics$always(author$project$ToasterTests$initToastersTest));
...
var author$project$Test$Generated$Main1123003763$main = A2(
	...
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'ToasterTests',
				_List_fromArray(
					[author$project$ToasterTests$tests]))
			])));
_Platform_export({'Test':{'Generated':{'Main1123003763':{'init':author$project$Test$Generated$Main1123003763$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-15582.sock";
